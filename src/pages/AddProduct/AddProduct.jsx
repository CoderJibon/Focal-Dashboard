...
import { createProduct } from "../../features/Product/productApiSlice.js";
...
const AddProduct = () => {
  ...
  brand.map((data, index) => {
    brandSelected.push({ value: data._id, label: data.name });
  });
  ...
  let schema = Yup.object().shape({
    ...
    productThumbnails: Yup.string().required(
      "product Thumbnails Image is required"
    ),
  });
  // from control
